...
// memset(serv_addr, 0, sizeof(struct sockaddr_in)); // Use memset instead of
// bzero
...
// int sync_msg = sendto(sockfd, "First msg", 10, 0, (struct sockaddr
// *)serv_addr,
...
// sync_msg =
//     recvfrom(sockfd, buffer, 255, 0, (struct sockaddr *)serv_addr,
//     &serv_len);
// if (sync_msg < 0) {
