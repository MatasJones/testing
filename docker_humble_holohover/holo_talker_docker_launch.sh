...
echo "$parent_dir"
docker run -d --privileged --network host -v $parent_dir/testing_logs:/home/testing/dev_ws/src/testing_logs --name "$CONTAINER_NAME" holo_testing_image tail -f /dev/null
