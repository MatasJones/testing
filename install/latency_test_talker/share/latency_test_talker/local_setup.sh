...
: ${AMENT_CURRENT_PREFIX:="/home/testing/dev_ws/src/install/latency_test_talker"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/latency_test_talker/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/latency_test_talker/environment/path.sh"
