...
custom_msg__msg__Int16msg__create()
{
  ...
  custom_msg__msg__Int16msg * msg = (custom_msg__msg__Int16msg *)allocator.allocate(sizeof(custom_msg__msg__Int16msg), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(custom_msg__msg__Int16msg));
  bool success = custom_msg__msg__Int16msg__init(msg);
  if (!success) {
...
custom_msg__msg__Int16msg__destroy(custom_msg__msg__Int16msg * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    custom_msg__msg__Int16msg__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
custom_msg__msg__Int16msg__Sequence__init(custom_msg__msg__Int16msg__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  custom_msg__msg__Int16msg * data = NULL;

  if (size) {
    data = (custom_msg__msg__Int16msg *)allocator.zero_allocate(size, sizeof(custom_msg__msg__Int16msg), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = custom_msg__msg__Int16msg__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        custom_msg__msg__Int16msg__fini(&data[i - 1]);
      }
...
custom_msg__msg__Int16msg__Sequence__fini(custom_msg__msg__Int16msg__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      custom_msg__msg__Int16msg__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  custom_msg__msg__Int16msg__Sequence * array = (custom_msg__msg__Int16msg__Sequence *)allocator.allocate(sizeof(custom_msg__msg__Int16msg__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = custom_msg__msg__Int16msg__Sequence__init(array, size);
  if (!success) {
...
custom_msg__msg__Int16msg__Sequence__destroy(custom_msg__msg__Int16msg__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    custom_msg__msg__Int16msg__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
custom_msg__msg__Int16msg__Sequence__are_equal(const custom_msg__msg__Int16msg__Sequence * lhs, const custom_msg__msg__Int16msg__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!custom_msg__msg__Int16msg__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  custom_msg__msg__Int16msg__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(custom_msg__msg__Int16msg);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    custom_msg__msg__Int16msg * data =
      (custom_msg__msg__Int16msg *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!custom_msg__msg__Int16msg__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          custom_msg__msg__Int16msg__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!custom_msg__msg__Int16msg__copy(
